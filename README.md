About segment-geospatial-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/segment-geospatial-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/segment-geospatial-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add samgeo segment-geospatial
# for installing globally
pixi global install samgeo segment-geospatial
```
...
It is possible to list all of the versions of `samgeo` available on your platform:
...
```
pixi search samgeo --channel conda-forge
```
